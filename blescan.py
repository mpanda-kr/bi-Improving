...
def parse_events(q, sock, loop_count=100):
    old_filter = sock.getsockopt( bluez.SOL_HCI, bluez.HCI_FILTER, 14)
    ...
    for i in range(0, loop_count):
		...
		i =0
		    ...
		    deacon_list = [ datetime.datetime.now(), mac_add, b_uuid, b_major, b_mainor, b_rssi, b_tx ]
                    Adstring = str(datetime.datetime.now())+"\t"+mac_add +","+b_uuid+","+b_major+","+b_mainor+","+b_rssi+","+b_tx
